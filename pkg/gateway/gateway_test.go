...
var _ = Describe("Run", func() {
	...
	It("should start the controllers", func(ctx context.Context) {
		...
		t.createRemoteClusterOnBroker(ctx)
...
func (t *testDriver) createRemoteClusterOnBroker(ctx context.Context) {
	test.CreateResource(ctx, t.clusters.Namespace(t.config.SyncerConfig.BrokerNamespace), &submarinerv1.Cluster{
		ObjectMeta: metav1.ObjectMeta{
