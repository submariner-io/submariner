...
// This Gateway Monitor runs on every GW node when Globalnet is enabled.
...
func (g *gatewayMonitor) startControllers() error {
	...
	// TODO(astoycos) implement the rest of the controllers // nolint:gocritic // TODO MAG POC

	// c, err = NewGlobalEgressIPController(g.syncerConfig, pool) // nolint:gocritic // TODO MAG POC
	// if err != nil {
	// 	return errors.Wrap(err, "error creating the GlobalEgressIP controller")
	// }

	// g.controllers = append(g.controllers, c) // nolint:gocritic // TODO MAG POC

	// The GlobalIngressIP controller needs to be started before the ServiceExport and Service controllers to ensure // nolint // TODO MAG POC
	...
	// podControllers, err := NewIngressPodControllers(g.syncerConfig) // nolint:gocritic // TODO MAG POC
	// if err != nil {
	// 	return errors.Wrap(err, "error creating the IngressPodControllers")
	// }

	// endpointsControllers, err := NewServiceExportEndpointsControllers(g.syncerConfig) // nolint:gocritic // TODO MAG POC
	// if err != nil {
	// 	return errors.Wrap(err, "error creating the Endpoints controller")
	// }

	// c, err = NewServiceExportController(g.syncerConfig, podControllers, endpointsControllers) // nolint:gocritic // TODO MAG POC
	// if err != nil {
	...
	// c, err = NewServiceController(g.syncerConfig, podControllers) // nolint:gocritic // TODO MAG POC
	// if err != nil {
...
// This function simply has a lot of error checks which inflates the cyclomatic complexity but logically
