...
func (i *Controller) syncPodRules(podIP, globalIP string, addOrDelete bool) {
...
func (i *Controller) syncServiceRules(service *k8sv1.Service, globalIP string, addOrDelete bool) {
