...
type SharedInformerFactory interface {
	...
	Submariner() submarinerio.Interface
}

func (f *sharedInformerFactory) Submariner() submarinerio.Interface {
	return submarinerio.New(f, f.namespace, f.tweakListOptions)
}
