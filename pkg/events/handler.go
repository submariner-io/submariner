...
type Handler interface {
	...
	// TransitionToNonGateway is called once in each node transitioning from Gateway to a non-Gateway.
	TransitionToNonGateway() error

	// TransitionToGateway is called once in each node transitioning from non-Gateway to a Gateway.
